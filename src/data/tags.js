...
export const ALLE_TAGS = [
  ...
  { id: 'protein-rig',    label: 'Proteinrig',          emoji: '💪', kategori: 'kost' },
  { id: 'kalorie-fattig', label: 'Kaloriefattig',       emoji: '🔥', kategori: 'kost' },
  { id: 'fiberrig',       label: 'Fiberrig',            emoji: '🌾', kategori: 'kost' },
  { id: 'anti-inflam',    label: 'Anti-inflammatorisk', emoji: '🫐', kategori: 'kost' },
  { id: 'morgenmad',      label: 'Morgenmad',           emoji: '🌅', kategori: 'kost' },
  { id: 'frokost',        label: 'Frokost',             emoji: '🥗', kategori: 'kost' },
  { id: 'aftensmad',      label: 'Aftensmad',           emoji: '🍽️', kategori: 'kost' },
  // Tid
...
export const ONBOARDING_TRIN = [
  ...
  {
    id: 'præferencer',
    spørgsmål: 'Hvad er dine ernæringsmål?',
    ikon: '🌟',
    multi: true,
    svar: [
      { label: '💪 Proteinrig kost',         tags: ['protein-rig'] },
      { label: '🔥 Kaloriefattig',           tags: ['kalorie-fattig'] },
      { label: '🌾 Fiberrig kost',           tags: ['fiberrig'] },
      { label: '🥑 Low-carb / LCHF',        tags: ['low-carb'] },
      { label: '🫐 Anti-inflammatorisk',     tags: ['anti-inflam', 'mere-grønt'] },
      { label: '⚡ Ingen særlige mål',       tags: [] },
    ],
  },
  {
    id: 'tid',
